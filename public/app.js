...
/***/ function(module, exports, __webpack_require__) {
	...
	function sanitizeArray(arr) {
	  return arr.map(function (elem, idx) {
	    return rp(String(idx), 2, '') + '_ ' + (elem + 1);
	  }).join("\r\n");
	}
	...
	sock.on('result', function (result) {
	  return randNumTarget.innerHTML = sanitizeArray(result);
	});
	sock.on('hide', function () {
	  return randNumTarget.innerHTML = '';
	});
